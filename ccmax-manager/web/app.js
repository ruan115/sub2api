...
function openGroup(item = null) {
  ...
  $("#group-claude-cli-version").value =
    item?.claude_cli_version || "2.1.220";
  ...
  $("#group-force-cache-ttl-5m").checked =
    item?.force_cache_ttl_5m_enabled ?? true;
    ...
    const payload = isOnboardingUser()
      ...
      : {
          ...
          cache_creation_detail_enabled: $("#group-cache-creation-detail")
            .checked,
          force_cache_ttl_5m_enabled: $("#group-force-cache-ttl-5m").checked,
